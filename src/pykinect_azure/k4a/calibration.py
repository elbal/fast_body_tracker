...
class Calibration:
    ...
    def handle(self) -> _k4a.k4a_calibration_t:
        return self._handle
    ...
    def get_k_matrix(self, camera: int) -> npt.NDArray[np.float32]:
        ...
        parameters_handler = {
            _k4a.K4A_CALIBRATION_TYPE_COLOR: np.array([
                [color_params.fx, 0, color_params.cx],
                [0, color_params.fy, color_params.cy],
                [0, 0, 1]
                ]),
            _k4a.K4A_CALIBRATION_TYPE_DEPTH: np.array([
    ...
    def convert_2d_to_3d(
            self, source_point2d: _k4a.k4a_float2, source_depth: float,
            source_camera: _k4a.k4a_calibration_type_t,
            target_camera: _k4a.k4a_calibration_type_t) -> _k4a.k4a_float3:
    ...
    def convert_2d_to_2d(
            ...
            source_camera: _k4a.k4a_calibration_type_t,
            target_camera: _k4a.k4a_calibration_type_t) -> _k4a.k4a_float2:
        conversion_fun = _k4a.k4a_calibration_2d_to_2d
    ...
    def convert_color_2d_to_depth_2d(
            self, source_point2d: _k4a.k4a_float2,
            depth_image: _k4a.k4a_image_t) -> _k4a.k4a_float2:
        conversion_fun = _k4a.k4a_calibration_color_2d_to_depth_2d
