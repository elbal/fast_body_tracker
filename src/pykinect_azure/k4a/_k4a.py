...
def k4a_device_open(device_id, device_handle):
	...
	_k4a_device_open.argtypes = (
		ctypes.c_uint32, ctypes.POINTER(k4a_device_t),)
...
def k4a_device_get_imu_sample(device_handle, imu_sample_handle, timeout):
	...
	return _k4a_device_get_imu_sample(
		device_handle, imu_sample_handle, timeout)
...
def k4a_image_create(image_format, width, height, stride, image_handle):
	...
	_k4a_image_create.argtypes = (
		k4a_image_format_t, ctypes.c_int, ctypes.c_int, ctypes.c_int,
...
def k4a_image_create_from_buffer(
		image_format, width, height, stride, buffer, buffer_size,
		buffer_release_cb, buffer_release_cb_context, image_handle):
	...
	_k4a_image_create_from_buffer.argtypes = (
		...
		ctypes.c_void_p, ctypes.POINTER(k4a_image_t),)
...
def k4a_image_get_device_timestamp_usec(image_handle):
	_k4a_image_get_device_timestamp_usec = (
		k4a_dll.k4a_image_get_device_timestamp_usec)
...
def k4a_image_get_system_timestamp_nsec(image_handle):
	_k4a_image_get_system_timestamp_nsec = (
		k4a_dll.k4a_image_get_system_timestamp_nsec)
...
def k4a_image_set_device_timestamp_usec(image_handle, timestamp_usec):
	_k4a_image_set_device_timestamp_usec = (
		k4a_dll.k4a_image_set_device_timestamp_usec)
...
def k4a_device_get_serialnum(device_handle, serial_number, serial_number_size):
	...
	return _k4a_device_get_serialnum(
		device_handle, serial_number, serial_number_size)
...
def k4a_device_get_color_control_capabilities(
		device_handle, command, supports_auto, min_value, max_value,
...
def k4a_device_set_color_control(device_handle, command, mode, value):
	...
	_k4a_device_set_color_control.argtypes = (
		k4a_device_t, k4a_color_control_command_t, k4a_color_control_mode_t,
		ctypes.c_int32,)
...
def k4a_device_get_raw_calibration(device_handle, data, data_size):
	...
	_k4a_device_get_raw_calibration.argtypes = (
		k4a_device_t, ctypes.POINTER(ctypes.c_uint8),
...
def k4a_calibration_get_from_raw(
	...
	_k4a_calibration_get_from_raw.argtypes = (
		ctypes.POINTER(ctypes.c_char), ctypes.c_size_t, k4a_depth_mode_t,
		k4a_color_resolution_t, ctypes.POINTER(k4a_calibration_t),)
...
def k4a_calibration_color_2d_to_depth_2d(
	...
	_k4a_calibration_color_2d_to_depth_2d = (
		k4a_dll.k4a_calibration_color_2d_to_depth_2d)
	_k4a_calibration_color_2d_to_depth_2d.restype = k4a_result_t
	_k4a_calibration_color_2d_to_depth_2d.argtypes = (
		ctypes.POINTER(k4a_calibration_t), ctypes.POINTER(k4a_float2_t),
		k4a_image_t, ctypes.POINTER(k4a_float2_t),
...
def k4a_transformation_depth_image_to_point_cloud(
	...
	_k4a_transformation_depth_image_to_point_cloud.argtypes = (
		k4a_transformation_t, k4a_image_t, k4a_calibration_type_t,
		k4a_image_t,)
