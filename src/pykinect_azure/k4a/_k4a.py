...
class K4aLib:
	...
	def _bind_all(cls):
		...
		cls._bind(
			...
			(
				_k4a_types.k4a_device_t, ctypes.POINTER(_k4a_types.k4a_capture_t),
				ctypes.c_int32))
		cls._bind(
			"k4a_device_get_imu_sample", ctypes.c_int,
			(
				_k4a_types.k4a_device_t, ctypes.POINTER(_k4a_types.k4a_imu_sample_t),
				ctypes.c_int32))
		cls._bind(
		...
		cls._bind(
			"k4a_device_get_color_control_capabilities", _k4a_types.k4a_result_t,
			(
				_k4a_types.k4a_device_t, _k4a_types.k4a_color_control_command_t,
		...
		cls._bind(
			...
			(_k4a_types.k4a_image_t,))
		cls._bind(
			"k4a_image_get_width_pixels", ctypes.c_int, (_k4a_types.k4a_image_t,))
		cls._bind(
		...
		cls._bind(
			"k4a_image_get_iso_speed", ctypes.c_uint32, (_k4a_types.k4a_image_t,))
		cls._bind(
			"k4a_image_set_device_timestamp_usec", None,
		...
		cls._bind(
			"k4a_transformation_depth_image_to_color_camera", _k4a_types.k4a_result_t,
			(
