...
class Calibration:
    ...
    def get_k_matrix(self, camera: int) -> npt.NDArray[np.float32]:
        color_params = self._handle.color_camera_calibration.intrinsics.parameters.param
        depth_params = self._handle.depth_camera_calibration.intrinsics.parameters.param
        parameters_handler = {
    ...
    def get_dist_params(self, camera: int) -> npt.NDArray[np.float32]:
        ...
        if intrinsics.type == k4a_const.K4A_CALIBRATION_LENS_DISTORTION_MODEL_THETA:
            ...
            return np.array(
                [params.k1, params.k2, params.k3, params.k4], dtype=np.float32
            )
    ...
    def get_extrinsics(
        self, input_camera: int, output_camera: int
    ...
    def convert_3d_to_3d(
        ...
        result_code = conversion_fun(
            ...
            ctypes.byref(source_point3d),
            source_camera,
            target_camera,
            ctypes.byref(target_point3d),
        )
    ...
    def convert_color_2d_to_depth_2d(
        self, source_point2d: k4a_float2, depth_image: k4a_image_t
    ) -> k4a_float2:
