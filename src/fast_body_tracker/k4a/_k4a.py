...
class K4aLib:
    ...
    def _bind_all(cls):
        ...
        cls._bind("k4a_device_close", None, (_k4a_types.k4a_device_t,))
        cls._bind(
        ...
        cls._bind("k4a_device_stop_cameras", None, (_k4a_types.k4a_device_t,))
        cls._bind(
            "k4a_device_start_imu", _k4a_types.k4a_result_t, (_k4a_types.k4a_device_t,)
        )
        cls._bind("k4a_device_stop_imu", None, (_k4a_types.k4a_device_t,))
        cls._bind(
            "k4a_device_get_serialnum",
            _k4a_types.k4a_buffer_result_t,
            (_k4a_types.k4a_device_t, ctypes.c_char_p, ctypes.POINTER(ctypes.c_size_t)),
        )
        cls._bind(
        ...
        cls._bind(
            ...
            (
                _k4a_types.k4a_device_t,
                _k4a_types.k4a_color_control_command_t,
                _k4a_types.k4a_color_control_mode_t,
                ctypes.c_int32,
            ),
        )
        cls._bind(
        ...
        cls._bind("k4a_capture_release", None, (_k4a_types.k4a_capture_t,))
        cls._bind("k4a_capture_reference", None, (_k4a_types.k4a_capture_t,))
        cls._bind(
        ...
        cls._bind(
            "k4a_capture_get_temperature_c", ctypes.c_float, (_k4a_types.k4a_capture_t,)
        )
        ...
        cls._bind("k4a_image_get_size", ctypes.c_size_t, (_k4a_types.k4a_image_t,))
        cls._bind(
            "k4a_image_get_format",
            _k4a_types.k4a_image_format_t,
            (_k4a_types.k4a_image_t,),
        )
        cls._bind("k4a_image_get_width_pixels", ctypes.c_int, (_k4a_types.k4a_image_t,))
        cls._bind(
            "k4a_image_get_height_pixels", ctypes.c_int, (_k4a_types.k4a_image_t,)
        )
        cls._bind("k4a_image_get_stride_bytes", ctypes.c_int, (_k4a_types.k4a_image_t,))
        cls._bind(
        ...
        cls._bind(
            "k4a_image_get_exposure_usec", ctypes.c_uint64, (_k4a_types.k4a_image_t,)
        )
        cls._bind(
            "k4a_image_get_white_balance", ctypes.c_uint32, (_k4a_types.k4a_image_t,)
        )
        cls._bind("k4a_image_get_iso_speed", ctypes.c_uint32, (_k4a_types.k4a_image_t,))
        cls._bind(
        ...
        cls._bind(
            "k4a_image_set_iso_speed", None, (_k4a_types.k4a_image_t, ctypes.c_uint32)
        )
        ...
        cls._bind(
            "k4a_transformation_destroy", None, (_k4a_types.k4a_transformation_t,)
        )
        cls._bind(
