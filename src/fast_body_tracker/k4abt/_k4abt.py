...
k4abt_tracker_default_configuration = _k4abt_types.k4abt_tracker_configuration_t()
...
def k4abt_frame_get_body_id(body_frame_handle, index):
    ...
    _k4abt_frame_get_body_id.argtypes = (_k4abt_types.k4abt_frame_t, ctypes.c_uint32)
...
def k4abt_frame_get_device_timestamp_usec(body_frame_handle):
    ...
    _k4abt_frame_get_device_timestamp_usec.argtypes = (_k4abt_types.k4abt_frame_t,)
