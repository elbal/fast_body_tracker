...
class Tracker:
    def __init__(
        self, calibration: Calibration, tracker_configuration: TrackerConfiguration
    ):
    ...
    def __del__(self):
        if self._handle:
            _k4abt.K4abLib.k4abt_tracker_destroy(self._handle)

    def update(
        self, capture: Capture, timeout_in_ms: int = k4a_const.K4A_WAIT_INFINITE
    ) -> Frame:
        result_code = _k4abt.K4abLib.k4abt_tracker_enqueue_capture(
        ...
        result_code = _k4abt.K4abLib.k4abt_tracker_pop_result(
