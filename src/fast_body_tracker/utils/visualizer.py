...
class PointCloudVisualizer:
    def __init__(self):
        ...
        self.view.camera = scene.cameras.TurntableCamera(fov=45, distance=2000, up="-y")
...
class IMUVisualizer:
    def __init__(self, max_samples=400):
        ...
        configs = [("m/s²", (-20, 20), "accel", 0), ("rad/s", (-5, 5), "gyro", 1)]

        for label, y_range, key, row in configs:
            yaxis = scene.AxisWidget(orientation="left", axis_label=label, font_size=8)
            yaxis.width_max = 60
